...
class QuizScreen1h extends StatefulWidget {
  const QuizScreen1h({super.key});

  @override
  State<QuizScreen1h> createState() => _QuizScreen1hState();
}

class _QuizScreen1hState extends State<QuizScreen1h>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Hard Quiz - Part I"),
